...
export class Donation80GComponent  {
    ...
    public addNewDonation100DeductionWithoutQualifyingLimit() {
    ...
    public deleteDonation100DeductionWithoutQualifyingLimitItem(index: number) {
        this.donation100DeductionWithoutQualifyingLimitModels.splice(index,1);
    }

    public addNewDonation50DeductionWithoutQualifyingLimit() {
    ...
    public deleteDonation50DeductionWithoutQualifyingLimitItem(index: number) {
        this.donation50DeductionWithoutQualifyingLimitModels.splice(index,1);
    }
    public addNewDonation100DeductionWithQualifyingLimit() {
        this._newDonation100DeductionWithoutQualifyingLimitModel = new DonationDeduction("","","",null,0,"",0,0);
    ...
    public deleteDonation100DeductionWithQualifyingLimitItem(index: number) {
        this.donation100DeductionWithQualifyingLimitModels.splice(index,1);
    }

    public addNewDonation50DeductionWithQualifyingLimit() {
    ...
    public deleteDonation50DeductionWithQualifyingLimitItem(index: number) {
